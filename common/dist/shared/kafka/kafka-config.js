...
let KafkaConfig = class KafkaConfig {
    constructor(kafkaModuleConfiguration) {
        this.kafkaModuleConfiguration = kafkaModuleConfiguration;
    }
    get() {
...
KafkaConfig = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject(constants_1.KAFKA_MODULE_CONFIGURATION)),
